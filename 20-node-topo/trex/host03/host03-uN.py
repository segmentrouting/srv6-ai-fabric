...
class STLIPv6(object):
    ...
    def get_streams(self, direction=0, **kwargs):
        ...
        port_config = {
            0: {
                'src': 'fc00:0:f800:8001::2',
                'dst': 'fc00:0:f800::2',
                'srv6_dst': 'fc00:0:1012:1008:1004:1000::'
            },
            1: {
                'src': 'fc00:0:f800:8005::2',
                'dst': 'fc00:0:f800:4::2',
                'srv6_dst': 'fc00:0:1013:1009:1005:1001::'
            },
            2: {
                'src': 'fc00:0:f800:8009::2',
                'dst': 'fc00:0:f800:8::2',
                'srv6_dst': 'fc00:0:1014:1010:1006:1002::'
            },
            3: {
                'src': 'fc00:0:f800:800d::2',
                'dst': 'fc00:0:f800:c::2',
                'srv6_dst': 'fc00:0:1015:1011:1007:1003::'
            }
        }
