...
docker exec -it clab-clos-host02 ip addr add fc00:0:f800:800c::2/64 dev eth4
...
docker exec -it clab-clos-host00 ip -6 route del fc00:0:f800:8000::/64
docker exec -it clab-clos-host00 ip -6 route del fc00:0:f800:8004::/64
docker exec -it clab-clos-host00 ip -6 route del fc00:0:f800:8008::/64
docker exec -it clab-clos-host00 ip -6 route del fc00:0:f800:800c::/64

docker exec -it clab-clos-host01 ip -6 route del fc00:0:f800:8001::/64
docker exec -it clab-clos-host01 ip -6 route del fc00:0:f800:8005::/64
docker exec -it clab-clos-host01 ip -6 route del fc00:0:f800:8009::/64
docker exec -it clab-clos-host01 ip -6 route del fc00:0:f800:800d::/64

docker exec -it clab-clos-host02 ip -6 route del fc00:0:f800::/64
docker exec -it clab-clos-host02 ip -6 route del fc00:0:f800:4::/64
docker exec -it clab-clos-host02 ip -6 route del fc00:0:f800:8::/64
docker exec -it clab-clos-host02 ip -6 route del fc00:0:f800:c::/64

docker exec -it clab-clos-host03 ip -6 route del fc00:0:f800:1::/64
docker exec -it clab-clos-host03 ip -6 route del fc00:0:f800:5::/64
docker exec -it clab-clos-host03 ip -6 route del fc00:0:f800:9::/64
docker exec -it clab-clos-host03 ip -6 route del fc00:0:f800:d::/64
