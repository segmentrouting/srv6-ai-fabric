...
class STLIPv6(object):
    ...
    def get_streams(self, direction=0, **kwargs):
        ...
        port_config = {
            0: {
                'src': 'fc00:0:f800:1::2',
                'dst': 'fc00:0:f800:8000::2',
                'srv6_dst': 'fc00:0:1006:1008:1014:1016::'
            },
            1: {
                'src': 'fc00:0:f800:5::2',
                'dst': 'fc00:0:f800:8004::2',
                'srv6_dst': 'fc00:0:1007:1009:1015:1017::'
            },
            2: {
                'src': 'fc00:0:f800:9::2',
                'dst': 'fc00:0:f800:8008::2',
                'srv6_dst': 'fc00:0:1004:1010:1012:1018::'
            },
            3: {
                'src': 'fc00:0:f800:d::2',
                'dst': 'fc00:0:f800:800c::2',
                'srv6_dst': 'fc00:0:1005:1011:1013:1019::'
            }
        }
