...
docker exec -it clab-sonic-host00 ip -6 route add 2001:db8:1008::/64 encap seg6 mode encap segs fc00:0:1000:1201:: dev eth1
docker exec -it clab-sonic-host00 ip -6 route add 2001:db8:1016::/64 encap seg6 mode encap segs fc00:0:1001:1202:: dev eth1
docker exec -it clab-sonic-host00 ip -6 route add 2001:db8:1024::/64 encap seg6 mode encap segs fc00:0:1002:1203:: dev eth1
...
docker exec -it clab-sonic-host08 ip -6 route add 2001:db8:1000::/64 encap seg6 mode encap segs fc00:0:1001:1200:: dev eth1
