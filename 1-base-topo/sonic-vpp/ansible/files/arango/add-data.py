...
# r01 = igp.get('2_0_0_0000.0000.0001')
...
# ipv4topo0102 = ipv4graph.get("2_0_0_0_0000.0000.0001_10.1.1.0_0000.0000.0002_10.1.1.1")
# ipv4topo0102['latency'] = 10
# ipv4topo0102['percent_util_out'] = 35
# ipv4topo0102['country_codes'] = ['NLD', 'DEU']
# ipv4graph.update(ipv4topo0102)

# ipv4topo0105 = ipv4graph.get("2_0_0_0_0000.0000.0001_10.1.1.8_0000.0000.0005_10.1.1.9")
# ipv4topo0105['latency'] = 5
# ipv4topo0105['percent_util_out'] = 55
# ipv4topo0105['country_codes'] = ['NLD', 'GBR']
# ipv4graph.update(ipv4topo0105)
