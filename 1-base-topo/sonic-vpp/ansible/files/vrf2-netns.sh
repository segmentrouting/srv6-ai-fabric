...
docker run -itd --name netns10-Eth08 iejalapeno/alpine:latest /bin/sh 
PID10=$(sudo docker inspect -f '{{.State.Pid}}' netns10-Eth08)
...
sudo brctl addif br22 10leaf
sudo ip netns exec $PID10 ip addr add fc00:0:f800:6::2/64 dev 10netns
...
sudo ip netns exec $PID10 ping fc00:0:f800:2::2 -c 2
